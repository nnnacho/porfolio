...
export const TAGS = {
  TypeScript: {
    name: "TypeScript",
    class:
      "border border-gray-900 text-[#094067] dark:text-[#fffffe] dark:border-[#ffffe]",
    icon: TypeScriptIcon,
  },
  NET: {
    name: ".NET",
    class:
      "border border-gray-900 text-[#094067] dark:text-[#fffffe] dark:border-[#fffffe]",
    icon: NETIcon,
  },
  TAILWIND: {
    name: "Tailwind CSS",
